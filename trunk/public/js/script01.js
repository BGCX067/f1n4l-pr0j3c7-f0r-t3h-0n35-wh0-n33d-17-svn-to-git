...
$(document).ready(function(){
	...
	$('.product').simpletip({
		...
		offset:[40,0],
		content:'<img src="http://projeto.final/img/ajax_load.gif" alt="loading" style="margin:10px;" />',
		onShow: function(){
			...
			this.load('http://projeto.final/cardapio/visualizar/id/' + fim[0],{img:param}); 
		} 
...
function addlist(param)
{
	...
	$.ajax({
	type: "POST",
	url: "http://projeto.final/cardapio/carrinho/id/"+im,
